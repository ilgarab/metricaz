...
export const testimonials = [
  ...
  {
    company: "Şam-fi",
    quote: "Metric-in satış auditi bizə tamamilə yeni perspektivlər açdı. Indi datalarımızı daha yaxşı başa düşürük və daha doğru qərarlar veririk.",
...
export const teamMembers = [
  ...
  { name: "Yalçın Talıbov", role: "ERP Consultant", initials: "YT" },
];
